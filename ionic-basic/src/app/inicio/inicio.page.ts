...
export class InicioPage implements OnInit {
  user = {nombre:'Juan Rodriguez', uuid:"34523452345234523452345", email:"correo@gmail.com"};

  list: any[]=
  [
    {nombre:'Juan Rodriguez', uuid:"34523452345234523452345", email:"correo@gmail.com"},
    {nombre:'Juan Rodriguez', uuid:"34523452345234523452345", email:"correo@gmail.com"},
    {nombre:'Juan Rodriguez', uuid:"34523452345234523452345", email:"correo@gmail.com"}
  ];
